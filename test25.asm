...
_test25:     file format elf32-i386
...
int main() {
  ...
  10:	81 ec 60 02 00 00    	sub    $0x260,%esp
    printf(1, "\n\n%s\n", test_name);
  16:	ff 35 08 10 00 00    	push   0x1008
  1c:	68 35 0a 00 00       	push   $0xa35
  21:	6a 01                	push   $0x1
...
00000630 <printint>:
 ...
 669:	0f b6 92 cc 0c 00 00 	movzbl 0xccc(%edx),%edx
...
000006e0 <printf>:
 ...
 759:	ff 24 85 74 0c 00 00 	jmp    *0xc74(,%eax,4)
 ...
 867:	90                   	nop
 868:	ba 6a 0c 00 00       	mov    $0xc6a,%edx
...
00000880 <free>:
 880:	55                   	push   %ebp
 881:	a1 0c 10 00 00       	mov    0x100c,%eax
 ...
 8c1:	5b                   	pop    %ebx
 8c2:	89 15 0c 10 00 00    	mov    %edx,0x100c
 8c8:	5e                   	pop    %esi
 8c9:	5f                   	pop    %edi
 8ca:	5d                   	pop    %ebp
 8cb:	c3                   	ret    
 ...
 8fc:	89 15 0c 10 00 00    	mov    %edx,0x100c
...
00000910 <malloc>:
 ...
 91c:	8b 3d 0c 10 00 00    	mov    0x100c,%edi
 ...
 961:	8b 3d 0c 10 00 00    	mov    0x100c,%edi
 ...
 98f:	8b 15 0c 10 00 00    	mov    0x100c,%edx
 ...
 9bf:	89 15 0c 10 00 00    	mov    %edx,0x100c
